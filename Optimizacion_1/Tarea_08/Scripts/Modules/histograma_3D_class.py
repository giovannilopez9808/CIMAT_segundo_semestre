...
def dibujar_punto(x, y):
    global status_clase
    color = [(255, 255, 255), (0, 0, 255), (255, 0, 0), (0, 255, 0),
             (0, 255, 255)]
...
def calcular_histogramas_OPTI(img, num_bins, clases, num_clases):
    ...
    for i in range(row):
        for j in range(col):
            ...
            hist[clase_id, bin_x, bin_y,
                 bin_z] = hist[clase_id, bin_x, bin_y, bin_z] + 1
...
if __name__ == '__main__':
    ...
    H = calcular_histogramas_OPTI(imagen_1, num_bins, matriz_clases_inicial,
                                  num_clases)
