...
for image_name in params["Images"]:
    ...
    image.segmentation(results.image, 3, results.alpha, results.mu, 0.5)
    image.histogram_segmentation(results.image, 3, results.h_0, results.h_1)
    image.plot(results.image, results.select_area, image_name)
